...
<head>
    <title>Code coverage report for hello-world.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> hello-world.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const html = String.raw;
&nbsp;
...
&nbsp;
  get name() {
    return this.getAttribute("name"<span class="branch-0 cbranch-no" title="branch not covered" >) ?? "";</span>
  }
&nbsp;
